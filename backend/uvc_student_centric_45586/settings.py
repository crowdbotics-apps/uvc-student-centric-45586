"""
Django settings for uvc_student_centric_45586 project.
...
ROOT_URLCONF = 'uvc_student_centric_45586.urls'
...
WSGI_APPLICATION = 'uvc_student_centric_45586.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "uvc_student_centric_45586 API",
    "DESCRIPTION": "API documentation for uvc_student_centric_45586 App",
    "VERSION": "v1",
}
